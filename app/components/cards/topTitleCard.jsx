...
export default function TopTitleCard({ title, value, bg, border }) {
  return (
    ...
    {/* <div className="col h-full w-full rounded-[6px] flex flex-col border border-[#05A305]"> */}
      <div className="col text-center">
        <p className="text-[40px]">{title}</p>
      </div>
      <div className={`col h-full rounded-[6px] flex justify-center items-center ${bg}`}>
      {/* <div className="col h-full rounded-[6px] flex justify-center items-center bg-[#05A305]"> */}
